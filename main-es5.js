...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      path: "favorites",
      component: _components_favorites_favorites_component__WEBPACK_IMPORTED_MODULE_4__["FavoritesComponent"]
    }, {
      path: "main/:q",
      component: _components_main_main_component__WEBPACK_IMPORTED_MODULE_3__["MainComponent"]
    }, {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_components_main_main_component__WEBPACK_IMPORTED_MODULE_6__["MainComponent"], _components_favorites_favorites_component__WEBPACK_IMPORTED_MODULE_7__["FavoritesComponent"], _components_header_header_component__WEBPACK_IMPORTED_MODULE_8__["HeaderComponent"], _components_layout_layout_component__WEBPACK_IMPORTED_MODULE_9__["LayoutComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_5__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], primeng_toast__WEBPACK_IMPORTED_MODULE_10__["ToastModule"]],
      providers: [],
  ...
  /***/
  function srcAppComponentsFavoritesFavoritesComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppComponentsFavoritesFavoritesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function FavoritesComponent(weather, router) {
        ...
        value: function ngOnInit() {
          ...
          for (var i = 0; i < localStorage.length; i++) {
            ...
            if (key.startsWith('favorite')) {
              list.push(value);
              keyList.push(key);
              this.weather.getCurrentWeather(value).subscribe(function (result) {
                anotherList = result;

                _this.favoritesLocation.push(anotherList);
              });
            }
          }
        }
      }, {
        key: "showFavoriteLocationOnMain",
        value: function showFavoriteLocationOnMain(favoritesLocation) {
          if (this.favoritesLocation = favoritesLocation) {
            this.router.navigate(["main", {
              q: favoritesLocation.LocalSource.Name,
              foo: 'foo'
            }]);
          }
        }
    ...
    FavoritesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/components/favorites/favorites.component.css")).default]
    })], FavoritesComponent);
    /***/
  },
    ...
    function () {
      ...
      _createClass(MainComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.weather.getFiveDaysDailyForecast('215854').subscribe(function (result) {
            _this2.dailyForecasts = result.DailyForecasts;
          });
        }
      }, {
        key: "addFavoriteLocation",
        value: function addFavoriteLocation() {
        ...
        value: function searchAutoComplete(q) {
          var _this3 = this;

          this.q = q;
          this.weather.getLocationAutoComplete(q).subscribe(function (result) {
            _this3.locationKey = result[0].Key;
            _this3.locationValue = result[0].LocalizedName;

            _this3.weather.getFiveDaysDailyForecast(_this3.locationKey).subscribe(function (res) {
              _this3.dailyForecasts = res.DailyForecasts;
            });

            _this3.weather.getCurrentWeather(_this3.locationKey).subscribe(function (currentWeatherResult) {
              _this3.currentWeather = currentWeatherResult;
            });
          });
        }
      }]);
  ...
  function srcAppServicesWeatherServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function WeatherService(client, rout) {
      ...
      _createClass(WeatherService, [{
        key: "getLocationAutoComplete",
        value: function getLocationAutoComplete(q) {
          return this.client.get("http://dataservice.accuweather.com/locations/v1/cities/autocomplete?apikey=" + this.apikey + "&q=" + q);
        }
      }, {
        key: "getCurrentWeather",
        value: function getCurrentWeather(locationKey) {
          return this.client.get("http://dataservice.accuweather.com/currentconditions/v1/" + locationKey + "?apikey=" + this.apikey);
        }
      }, {
        key: "getFiveDaysDailyForecast",
        value: function getFiveDaysDailyForecast(locationKey) {
          return this.client.get("http://dataservice.accuweather.com/forecasts/v1/daily/5day/" + locationKey + "?apikey=" + this.apikey);
        }
      }]);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Tom\TomAngularWorkSpace\WeatherApp\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
